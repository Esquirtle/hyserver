...
public abstract class ContentFieldAsset
implements Cleanable,
JsonAssetWithMap<String, DefaultAssetMap<String, ContentFieldAsset>> {
    public static final AssetCodecMapCodec<String, ContentFieldAsset> CODEC = new AssetCodecMapCodec<String, ContentFieldAsset>(Codec.STRING, (t, k) -> {
        t.id = k;
    }, t -> t.id, (t, data) -> {
        t.data = data;
    }, t -> t.data);
