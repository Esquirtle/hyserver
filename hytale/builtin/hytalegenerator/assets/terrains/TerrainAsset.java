...
public abstract class TerrainAsset
implements Cleanable,
JsonAssetWithMap<String, DefaultAssetMap<String, TerrainAsset>> {
    private static final TerrainAsset[] EMPTY_INPUTS = new TerrainAsset[0];
    public static final AssetCodecMapCodec<String, TerrainAsset> CODEC = new AssetCodecMapCodec<String, TerrainAsset>(Codec.STRING, (t, k) -> {
        t.id = k;
    }, t -> t.id, (t, data) -> {
        t.data = data;
    }, t -> t.data);
