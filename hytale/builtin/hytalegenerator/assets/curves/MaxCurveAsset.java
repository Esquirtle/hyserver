...
extends CurveAsset {
    public static final BuilderCodec<MaxCurveAsset> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(MaxCurveAsset.class, MaxCurveAsset::new, CurveAsset.ABSTRACT_CODEC).append(new KeyedCodec<T[]>("Curves", new ArrayCodec(CurveAsset.CODEC, CurveAsset[]::new), true), (t, k) -> {
        t.curveAssets = k;
