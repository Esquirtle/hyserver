...
extends DensityAsset {
    public static final BuilderCodec<PositionsCellNoiseDensityAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PositionsCellNoiseDensityAsset.class, PositionsCellNoiseDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec("Positions", PositionProviderAsset.CODEC, true), (asset, v) -> {
        ...
        asset.returnTypeAsset = v;
    }, asset -> asset.returnTypeAsset).add()).append(new KeyedCodec("DistanceFunction", DistanceFunctionAsset.CODEC, true), (asset, v) -> {
        asset.distanceFunctionAsset = v;
    }, asset -> asset.distanceFunctionAsset).add()).append(new KeyedCodec<Double>("MaxDistance", Codec.DOUBLE, true), (asset, v) -> {
        asset.maxDistance = v;
    }, asset -> asset.maxDistance).addValidator(Validators.greaterThanOrEqual(0.0)).add()).build();
