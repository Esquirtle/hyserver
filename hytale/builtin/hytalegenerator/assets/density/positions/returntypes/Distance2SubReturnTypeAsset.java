...
extends ReturnTypeAsset {
    public static final BuilderCodec<Distance2SubReturnTypeAsset> CODEC = BuilderCodec.builder(Distance2SubReturnTypeAsset.class, Distance2SubReturnTypeAsset::new, ReturnTypeAsset.ABSTRACT_CODEC).build();
