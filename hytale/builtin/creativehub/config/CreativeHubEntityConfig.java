...
implements Component<EntityStore> {
    ...
    public static final BuilderCodec<CreativeHubEntityConfig> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(CreativeHubEntityConfig.class, CreativeHubEntityConfig::new).appendInherited(new KeyedCodec("ParentHubWorldUuid", Codec.UUID_STRING), (o, i) -> {
        o.parentHubWorldUuid = i;
    }, o -> o.parentHubWorldUuid, (o, p) -> {
        o.parentHubWorldUuid = p.parentHubWorldUuid;
    }).add()).build();
    @Nullable
    ...
    public static CreativeHubEntityConfig ensureAndGet(@Nonnull Holder<EntityStore> holder) {
        ComponentType<EntityStore, CreativeHubEntityConfig> type = CreativeHubEntityConfig.getComponentType();
