...
public class BlockSoundSet {
    ...
    public static BlockSoundSet deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 4) != 0) {
            ...
            obj.soundEventIndices = new HashMap<BlockSoundEvent, Integer>(soundEventIndicesCount);
            ...
            for (int i = 0; i < soundEventIndicesCount; ++i) {
                ...
                dictPos += 4;
                if (obj.soundEventIndices.put(key, val) == null) continue;
                throw ProtocolException.duplicateKey("soundEventIndices", (Object)key);
            }
        }
        return obj;
    }
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 4) != 0) {
            ...
            pos = offset + 17 + soundEventIndicesOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public BlockSoundSet clone() {
        ...
        copy.id = this.id;
        copy.soundEventIndices = this.soundEventIndices != null ? new HashMap<BlockSoundEvent, Integer>(this.soundEventIndices) : null;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BlockSoundSet)) {
            return false;
        }
