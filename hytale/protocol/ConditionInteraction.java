...
extends SimpleInteraction {
    ...
    public int serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.jumping != null) {
            buf.writeByte(this.jumping != false ? 1 : 0);
        } else {
            buf.writeZero(1);
        }
        if (this.swimming != null) {
            buf.writeByte(this.swimming != false ? 1 : 0);
        } else {
            buf.writeZero(1);
        }
        if (this.crouching != null) {
            buf.writeByte(this.crouching != false ? 1 : 0);
        } else {
            buf.writeZero(1);
        }
        if (this.running != null) {
            buf.writeByte(this.running != false ? 1 : 0);
        } else {
            buf.writeZero(1);
        }
        if (this.flying != null) {
            buf.writeByte(this.flying != false ? 1 : 0);
        } else {
            buf.writeZero(1);
        }
        ...
        if (this.tags != null) {
            ...
            for (Object item : (Object)this.tags) {
                buf.writeIntLE((int)item);
            }
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ConditionInteraction)) {
            return false;
        }
        ConditionInteraction other = (ConditionInteraction)obj;
        return Objects.equals((Object)this.waitForDataFrom, (Object)other.waitForDataFrom) && Objects.equals(this.effects, other.effects) && this.horizontalSpeedMultiplier == other.horizontalSpeedMultiplier && this.runTime == other.runTime && this.cancelOnItemChange == other.cancelOnItemChange && Objects.equals(this.settings, other.settings) && Objects.equals(this.rules, other.rules) && Arrays.equals(this.tags, other.tags) && Objects.equals(this.camera, other.camera) && this.next == other.next && this.failed == other.failed && Objects.equals((Object)this.requiredGameMode, (Object)other.requiredGameMode) && Objects.equals(this.jumping, other.jumping) && Objects.equals(this.swimming, other.swimming) && Objects.equals(this.crouching, other.crouching) && Objects.equals(this.running, other.running) && Objects.equals(this.flying, other.flying);
    }
