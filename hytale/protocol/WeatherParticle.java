...
public class WeatherParticle {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof WeatherParticle)) {
            return false;
        }
    ...
    public int hashCode() {
        return Objects.hash(this.systemId, this.color, Float.valueOf(this.scale), this.isOvergroundOnly, Float.valueOf(this.positionOffsetMultiplier));
    }
}
