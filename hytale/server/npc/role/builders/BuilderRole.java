...
implements SpawnEffect {
    ...
    protected final BuilderObjectReferenceHelper<Map<String, MotionController>> motionControllers = new BuilderObjectReferenceHelper(BuilderMotionControllerMapUtil.CLASS_REFERENCE, this);
    ...
    protected final BuilderObjectReferenceHelper<StateTransitionController> stateTransitionController = new BuilderObjectReferenceHelper(StateTransitionController.class, this);
    protected final StringHolder initialMotionController = new StringHolder();
    protected final BuilderCodecObjectHelper<StateEvaluator> stateEvaluator = new BuilderCodecObjectHelper<StateEvaluator>(StateEvaluator.class, StateEvaluator.CODEC, null);
    ...
    public boolean validate(String configName, @Nonnull NPCLoadTimeValidationHelper validationHelper, @Nonnull ExecutionContext context, Scope globalScope, @Nonnull List<String> errors) {
        ...
        if (mc != null) {
            BuilderFactory factory = this.builderManager.getFactory(MotionController.class);
            try {
    ...
    public BuilderRole readConfig(@Nonnull JsonElement data) {
        ...
        this.getString(data, "Debug", (String e) -> {
            this.debugFlags = e;
        }, "", null, BuilderDescriptorState.WorkInProgress, "Debugging flags", null);
        this.requireAsset(data, "Appearance", this.appearance, (AssetValidator)ModelExistsValidator.required(), BuilderDescriptorState.Stable, "Model to use for rendering", null);
        this.getStringArray(data, "DisplayNames", a -> {
            this.displayNames = a;
        }, null, null, StringArrayNoEmptyStringsValidator.get(), BuilderDescriptorState.Stable, "List of possible display names to choose from", null);
        this.requireString(data, "NameTranslationKey", this.nameTranslationKey, (StringValidator)StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The translation key for this NPC's name", null);
        this.getAsset(data, "OpaqueBlockSet", (String v) -> {
            this.opaqueBlockSet = v;
        }, "Opaque", (AssetValidator)BlockSetExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "Blocks blocking line of sight", null);
        ...
        this.getInt(data, "HotbarSize", (int v) -> {
            this.hotbarSlots = v;
        }, 3, (IntValidator)IntRangeValidator.between(3, 8), BuilderDescriptorState.Stable, "Number of available hotbar slots", null);
        this.getInt(data, "OffHandSlots", (int v) -> {
            this.offHandSlots = v;
        }, 0, (IntValidator)IntRangeValidator.between(0, 4), BuilderDescriptorState.Stable, "The number of slots for off-hand items", null);
        ...
        this.getAsset(data, "PossibleInventoryItems", this.inventoryItemsDropList, null, (AssetValidator)ItemDropListExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "A droplist defining the possible items the NPCs inventory could contain", null);
        this.getInt(data, "DefaultOffHandSlot", this.defaultOffHandSlot, -1, (IntValidator)IntRangeValidator.between(-1, 4), BuilderDescriptorState.Stable, "The default off-hand item slot (-1 is empty)", null);
        this.getAssetArray(data, "Armor", a -> {
            this.armor = a;
        }, null, null, ItemExistsValidator.withConfig(AssetValidator.ListCanBeEmpty), BuilderDescriptorState.WorkInProgress, "Armor items", null);
        this.getAsset(data, "DropList", this.dropListId, null, (AssetValidator)ItemDropListExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "Drop list to spawn when killed", null);
        this.getString(data, "StartState", (String s) -> {
            this.startState = s;
        }, "start", (StringValidator)StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "Initial state", null);
        this.getDefaultSubState(data, "DefaultSubState", v -> {
            this.defaultSubState = v;
        }, StringNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The default sub state to reference when transitioning to a main state without a specified sub state", null);
        this.getDouble(data, "CollisionDistance", (double d) -> {
            this.collisionDistance = d;
        }, 5.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Collision lookahead", null);
        this.getDouble(data, "CollisionForceFalloff", (double d) -> {
            this.collisionForceFalloff = d;
        }, 2.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Falloff rate for collision force", null);
        this.getDouble(data, "CollisionRadius", (double d) -> {
            this.collisionRadius = d;
        }, -1.0, null, BuilderDescriptorState.Experimental, "Collision radius override", null);
        ...
        this.getEnum(data, "AvoidanceMode", (E e) -> {
            this.avoidanceMode = e;
        }, Role.AvoidanceMode.class, Role.AvoidanceMode.Any, BuilderDescriptorState.Experimental, "Abilities to use for avoidance", null);
        this.getDouble(data, "EntityAvoidanceStrength", (double d) -> {
            this.entityAvoidanceStrength = d;
        }, 1.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "Blending factor avoidance", null);
        this.getBoolean(data, "StayInEnvironment", (boolean b) -> {
            this.stayInEnvironment = b;
        }, false, BuilderDescriptorState.Experimental, "Stay in spawning environment", null);
        this.getString(data, "AllowedEnvironments", (String s) -> {
            this.allowedEnvironments = s;
        }, null, (StringValidator)StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Experimental, "Allowed environment to walk in", null);
        ...
        this.getDouble(data, "FlockWeightAlignment", (double v) -> {
            this.flockWeightAlignment = v;
        }, 1.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Blending flock alignment", null);
        this.getDouble(data, "FlockWeightSeparation", (double v) -> {
            this.flockWeightSeparation = v;
        }, 1.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Blending flock separation", null);
        this.getDouble(data, "FlockWeightCohesion", (double v) -> {
            this.flockWeightCohesion = v;
        }, 1.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Blending flock cohesion", null);
        this.getDouble(data, "FlockInfluenceRange", (double v) -> {
            this.flockInfluenceRange = v;
        }, 10.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Influence radius flock forces", null);
        this.getBoolean(data, "DisableDamageFlock", (boolean b) -> {
            this.disableDamageFlock = b;
        }, true, BuilderDescriptorState.WorkInProgress, "If true disables combat damage from flock members", null);
        ...
        this.getExistentStateSet(data, "BusyStates", s -> {
            this.busyStates = s;
        }, this.stateHelper, BuilderDescriptorState.Stable, "States during which this NPC is busy and can't be interacted with", null);
        ...
        this.getBoolean(data, "PickupDropOnDeath", (boolean t) -> {
            this.pickupDropOnDeath = t;
        }, false, BuilderDescriptorState.Stable, "Drop last picked item on death", null);
        this.getDouble(data, "DeathAnimationTime", (double d) -> {
            this.deathAnimationTime = d;
        }, 5.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "How long to let the death animation play before removing", null);
        this.getAsset(data, "DeathInteraction", this.deathInteraction, null, (AssetValidator)RootInteractionValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Experimental, "Interaction to run on death", null);
        this.getFloat(data, "DespawnAnimationTime", (float d) -> {
            this.despawnAnimationTime = d;
        }, 0.8f, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "How long to let the despawn animation play before removing", null);
        this.getString(data, "SpawnParticles", (String v) -> {
            this.spawnParticles = v;
        }, null, null, BuilderDescriptorState.Experimental, "Particle system when spawning", null);
        this.getVector3d(data, "SpawnParticlesOffset", (double[] v) -> {
            this.spawnParticleOffset = v;
        }, null, null, BuilderDescriptorState.Experimental, "Displacement from foot point to spawn relative to NPC heading", null);
        this.getDouble(data, "SpawnViewDistance", (double v) -> {
            this.spawnViewDistance = v;
        }, 75.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "View distance for spawn particle", null);
        ...
        this.getAsset(data, "AttitudeGroup", this.attitudeGroup, null, (AssetValidator)AttitudeGroupExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.NULLABLE)), BuilderDescriptorState.Stable, "The attitude group towards other NPCs this NPC belongs to (often species related)", null);
        this.getAsset(data, "ItemAttitudeGroup", this.itemAttitudeGroup, null, (AssetValidator)ItemAttitudeGroupExistsValidator.withConfig(EnumSet.of(AssetValidator.Config.NULLABLE)), BuilderDescriptorState.Stable, "This NPC's item attitudes", null);
        ...
        this.getString(data, "InitialMotionController", this.initialMotionController, null, (StringValidator)StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "The initial motion controller to set", "The initial motion controller to set. If omitted and there are multiple, one will be chosen at random.");
        ...
        this.getString(data, "MemoriesCategory", this.memoriesCategory, "Other", (StringValidator)StringNullOrNotEmptyValidator.get(), BuilderDescriptorState.Stable, "Category to put the NPC in, as part of the Memories Plugin", null);
        ...
        this.getFloat(data, "SpawnLockTime", this.spawnLockTime, 1.5, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Stable, "How long the NPC should be locked and unable to perform behavior when first spawned", null);
    ...
    public SpawnTestResult canSpawn(@Nonnull SpawningContext context) {
        ...
        if (builder instanceof ISpawnable) {
            SpawnTestResult result = ((ISpawnable)((Object)builder)).canSpawn(context);
    ...
    public Vector3d getSpawnParticleOffset() {
        return BuilderRole.createVector3d(this.spawnParticleOffset, Vector3d.ZERO::clone);
    }
    ...
    public float getCollisionViewAngle() {
        return (float)Math.PI / 180 * this.collisionViewAngle;
    }
    ...
    protected void runLoadTimeValidationHelper0(String configName, NPCLoadTimeValidationHelper loadTimeValidationHelper, ExecutionContext context, @Nonnull List<String> errors) {
        ...
        if (spawnTypes != null) {
            for (String type : spawnTypes) {
                if (npcModule.hasRoleName(type)) continue;
                success = false;
                errors.add(String.format("%s: No such role '%s' for %s", configName, type, this.flockSpawnTypes.getName()));
            }
        }
        if ((allowedTypes = this.flockAllowedRoles.get(context)) != null) {
