...
public class BuilderMotionControllerWalk
extends BuilderMotionControllerBase {
    ...
    public BuilderMotionControllerWalk readConfig(@Nonnull JsonElement data) {
        this.getDouble(data, "MaxWalkSpeed", this.maxHorizontalSpeed, 3.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum horizontal speed", null);
        this.getDouble(data, "MinWalkSpeed", (double v) -> {
            this.minHorizontalSpeed = v;
        }, 0.1, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Minimum horizontal speed", null);
        this.getDouble(data, "MaxFallSpeed", (double v) -> {
            this.maxVerticalSpeed = v;
        }, 8.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum fall speed", null);
        this.getDouble(data, "MaxSinkSpeedFluid", (double v) -> {
            this.maxVerticalSpeedFluid = v;
        }, 4.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum sink speed in fluids", null);
        this.getDouble(data, "Gravity", (double v) -> {
            this.gravity = v;
        }, 10.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Gravity", null);
        this.getDouble(data, "Acceleration", this.acceleration, 3.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Acceleration", null);
        this.getDouble(data, "MaxRotationSpeed", this.maxRotationSpeed, 360.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum rotational speed in degrees", null);
        this.getFloat(data, "MaxWalkTurnAngle", this.maxMoveTurnAngle, 90.0, (DoubleValidator)DoubleRangeValidator.between(0.0, 180.0), BuilderDescriptorState.WorkInProgress, "Maximum angle NPC can walk without explicit turning in degrees", null);
        this.getFloat(data, "BlendRestTurnAngle", this.blendRestTurnAngle, 60.0, (DoubleValidator)DoubleRangeValidator.between(0.0, 180.0), BuilderDescriptorState.WorkInProgress, "When NPC is blending heading and turn angle required is larger than this value speed is reduced", null);
        this.getDouble(data, "BlendRestRelativeSpeed", this.blendRestRelativeSpeed, 0.2, (DoubleValidator)DoubleRangeValidator.between01(), BuilderDescriptorState.WorkInProgress, "When NPC is blending heading relative speed used when reducing speed", null);
        this.getDouble(data, "MaxClimbHeight", this.maxClimbHeight, 1.3, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Stable, "Maximum height NPC can climb", null);
        this.getDouble(data, "JumpHeight", this.jumpHeight, 0.5, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "How high the NPC jumps above climb height", null);
        this.getDouble(data, "MinJumpHeight", this.minJumpHeight, 0.6, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "Minimum height above which a jump will be attempted", null);
        this.getDouble(data, "MinJumpDistance", this.minJumpDistance, 0.2, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Minimum distance above which a jump will be executed", null);
        this.getDouble(data, "JumpForce", this.jumpForce, 1.5, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "The force multiplier for the upward motion of the jump", null);
        ...
        this.getAsset(data, "FenceBlockSet", (String v) -> {
            this.fenceBlockSet = v;
        }, "Fence", (AssetValidator)BlockSetExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "Unclimbable blocks", null);
        this.getDoubleRange(data, "JumpRange", this.jumpRange, DEFAULT_JUMP_RANGE, (DoubleArrayValidator)DoubleSequenceValidator.betweenWeaklyMonotonic(0.0, 10.0), BuilderDescriptorState.WorkInProgress, "Jump distance range", null);
        this.getDouble(data, "MinHover", (double v) -> {
            this.minHover = v;
        }, 0.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Minimum hover height over ground", null);
        this.getDouble(data, "MinHoverClimb", (double v) -> {
            this.minHoverClimb = v;
        }, 0.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Minimum hover height over ground when climbing", null);
        this.getDouble(data, "MinHoverDrop", (double v) -> {
            this.minHoverDrop = v;
        }, 0.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Minimum hover height over ground when dropping", null);
        this.getBoolean(data, "FloatsDown", (boolean v) -> {
            this.floatsDown = v;
        }, true, BuilderDescriptorState.WorkInProgress, "If true NPC floats down when hovering enabled else gravity decides", null);
        this.getDouble(data, "MaxHover", (double v) -> {
            this.maxHover = v;
        }, 0.0, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Maximum hover height over ground", null);
        this.getFloat(data, "HoverFreq", (float v) -> {
            this.hoverFreq = v;
        }, 0.0f, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.WorkInProgress, "Hover frequency", null);
        this.getDouble(data, "MinHitSlowdown", (double v) -> {
            this.maxWalkSpeedAfterHitMultiplier = 1.0 - v;
        }, 0.1, (DoubleValidator)DoubleRangeValidator.between01(), BuilderDescriptorState.Stable, "The minimum percentage to slow down by when attacked from behind", null);
    ...
    public float getMaxMoveTurnAngle(@Nonnull BuilderSupport builderSupport) {
        return (float)Math.PI / 180 * this.maxMoveTurnAngle.get(builderSupport.getExecutionContext());
    }
    ...
    public float getBlendRestTurnAngle(@Nonnull BuilderSupport builderSupport) {
        return (float)Math.PI / 180 * this.blendRestTurnAngle.get(builderSupport.getExecutionContext());
    }
