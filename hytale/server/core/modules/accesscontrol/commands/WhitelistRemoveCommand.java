...
extends AbstractAsyncCommand {
    ...
    @Nonnull
    private final RequiredArg<ProfileServiceClient.PublicGameProfile> playerArg = this.withRequiredArg("player", "server.commands.whitelist.remove.player.desc", ArgTypes.GAME_PROFILE_LOOKUP);
