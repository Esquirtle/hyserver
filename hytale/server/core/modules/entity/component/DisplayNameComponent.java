...
implements Component<EntityStore> {
    @Nonnull
    public static final BuilderCodec<DisplayNameComponent> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DisplayNameComponent.class, DisplayNameComponent::new).appendInherited(new KeyedCodec("DisplayName", Message.CODEC), (e, s) -> {
        e.displayName = s;
    }, e -> e.displayName, (e, p) -> {
        e.displayName = p.displayName;
    }).documentation("The value of the display name.").add()).build();
    @Nullable
