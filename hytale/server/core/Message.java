...
public class Message {
    ...
    private static final Codec<ParamValue> PARAM_CODEC = new ParamValueCodec();
    private static final Codec<MaybeBool> MAYBE_BOOL_CODEC = new MaybeBoolCodec();
    ...
    public Message insert(@Nonnull String message) {
        return this.insert(Message.raw(message));
    }
    ...
    public List<Message> getChildren() {
        ...
        ObjectArrayList<Message> children = new ObjectArrayList<Message>();
    ...
    static {
        ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)MESSAGE_CODEC_BUILDER.appendInherited(new KeyedCodec<String>("RawText", Codec.STRING), (o, v) -> {
            o.rawText = v;
        }, o -> o.rawText, (o, p) -> {
            o.rawText = p.rawText;
        }).add()).appendInherited(new KeyedCodec<String>("MessageId", Codec.STRING), (o, v) -> {
            o.messageId = v;
        }, o -> o.messageId, (o, p) -> {
            o.messageId = p.messageId;
        }).add()).appendInherited(new KeyedCodec("Params", new MapCodec<ParamValue, HashMap>(PARAM_CODEC, HashMap::new)), (o, v) -> {
            o.params = v;
        }, o -> o.params, (o, p) -> {
            o.params = p.params;
        }).add()).appendInherited(new KeyedCodec("MessageParams", new MapCodec<FormattedMessage, HashMap>(MESSAGE_CODEC, HashMap::new)), (o, v) -> {
            o.messageParams = v;
        }, o -> o.messageParams, (o, p) -> {
            o.messageParams = p.messageParams;
        }).add()).appendInherited(new KeyedCodec<T[]>("Children", new ArrayCodec<FormattedMessage>(MESSAGE_CODEC, FormattedMessage[]::new)), (o, v) -> {
            o.children = v;
        }, o -> o.children, (o, p) -> {
            o.children = p.children;
        }).add()).appendInherited(new KeyedCodec<MaybeBool>("Bold", MAYBE_BOOL_CODEC), (o, v) -> {
            o.bold = v != null ? v : MaybeBool.Null;
        }, o -> o.bold, (o, p) -> {
            o.bold = p.bold;
        }).add()).appendInherited(new KeyedCodec<MaybeBool>("Italic", MAYBE_BOOL_CODEC), (o, v) -> {
            o.italic = v != null ? v : MaybeBool.Null;
        }, o -> o.italic, (o, p) -> {
            o.italic = p.italic;
        }).add()).appendInherited(new KeyedCodec<MaybeBool>("Monospace", MAYBE_BOOL_CODEC), (o, v) -> {
            o.monospace = v != null ? v : MaybeBool.Null;
        }, o -> o.monospace, (o, p) -> {
            o.monospace = p.monospace;
        }).add()).appendInherited(new KeyedCodec<MaybeBool>("Underline", MAYBE_BOOL_CODEC), (o, v) -> {
            o.underlined = v != null ? v : MaybeBool.Null;
        }, o -> o.underlined, (o, p) -> {
            o.underlined = p.underlined;
        }).add()).appendInherited(new KeyedCodec<String>("Color", Codec.STRING), (o, v) -> {
            o.color = v;
        }, o -> o.color, (o, p) -> {
            o.color = p.color;
        }).add()).appendInherited(new KeyedCodec<String>("Link", Codec.STRING), (o, v) -> {
            o.link = v;
        }, o -> o.link, (o, p) -> {
            o.link = p.link;
        }).add();
    ...
    private static class ParamValueCodec
    implements Codec<ParamValue> {
        ...
        public ParamValue decode(BsonValue bsonValue, ExtraInfo extraInfo) {
            return switch (bsonValue.getBsonType()) {
                ...
                default -> throw new IllegalArgumentException("Unsupported bson type: " + String.valueOf((Object)bsonValue.getBsonType()));
            };
        }
        ...
        public BsonValue encode(ParamValue paramValue, ExtraInfo extraInfo) {
            ...
            Objects.requireNonNull(paramValue2);
            ParamValue paramValue3 = paramValue2;
            int n = 0;
            return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{StringParamValue.class, BoolParamValue.class, DoubleParamValue.class, IntParamValue.class, LongParamValue.class}, (Object)paramValue3, n)) {
                case 0 -> {
                    StringParamValue s = (StringParamValue)paramValue3;
                    yield new BsonString(s.value);
                }
                case 1 -> {
                    BoolParamValue b = (BoolParamValue)paramValue3;
                    yield BsonBoolean.valueOf(b.value);
                }
                case 2 -> {
                    DoubleParamValue d = (DoubleParamValue)paramValue3;
                    yield new BsonDouble(d.value);
                }
                case 3 -> {
                    IntParamValue i = (IntParamValue)paramValue3;
                    yield new BsonInt32(i.value);
                }
                case 4 -> {
                    LongParamValue l = (LongParamValue)paramValue3;
    ...
    private static class MaybeBoolCodec
    implements Codec<MaybeBool> {
        ...
        public BsonValue encode(MaybeBool maybeBool, ExtraInfo extraInfo) {
            return switch (maybeBool) {
                ...
                case MaybeBool.Null -> BsonNull.VALUE;
                case MaybeBool.False -> BsonBoolean.FALSE;
                case MaybeBool.True -> BsonBoolean.TRUE;
            };
        }
