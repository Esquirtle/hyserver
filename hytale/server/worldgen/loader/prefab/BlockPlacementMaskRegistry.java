...
extends FileMaskCache<BlockMaskCondition> {
    @Nonnull
    private final Map<BlockMaskCondition, BlockMaskCondition> masks = new HashMap<BlockMaskCondition, BlockMaskCondition>();
    @Nonnull
    private final Map<BlockMaskCondition.MaskEntry, BlockMaskCondition.MaskEntry> entries = new HashMap<BlockMaskCondition.MaskEntry, BlockMaskCondition.MaskEntry>();
